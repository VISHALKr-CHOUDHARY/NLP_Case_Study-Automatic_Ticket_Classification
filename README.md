...
Based on these metrics, the Logistic Regression model performed the best, with high accuracy. The Decision Tree and Random Forest models also performed reasonably well, with an accuracy of 0.77 and 0.74, respectively. The NB model had the lowest performance, with an accuracy of 0.36.
